...
<form action="addSupplier" class="form-horizontal" method="post" onsubmit="return formSupplier()" enctype="multipart/form-data">
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="email">Brand Name:</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" name="SupplierName" id="suppliername"  placeholder="Enter Brand Name" required>
    </div>
  </div>
  <div class="form-group">
